...
bot.on('message', message => {
	fileArray.forEach(function(file){
      ...
      message.delete(1000);
			message.channel.send('Hello, ' + message.author + ' I successfully played the soundboard template you have requested ' + fileName + '.mp3');
		}
	});
	if (message.content === (PREFIX + 'stop')){
		message.channel.send('This feature is being worked on!');
